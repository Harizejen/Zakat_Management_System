                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" id="stud_phoneNum" name="stud_phoneNum" pattern="\d{10,11}" title="Please enter a valid phone number (10-11 digits)" value="<%= st != null ? st.getStudPhoneNum() : ""%>" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="stud_gender" id="lelaki" value="L" <%= st != null && st.getStudGender() == 'L' ? "checked" : ""%> required>
                                    <label class="form-check-label" for="lelaki">Lelaki</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="stud_gender" id="perempuan" value="P" <%= st != null && st.getStudGender() == 'P' ? "checked" : ""%> required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="stud_marriage" id="bujang" value="S" <%= st != null && st.getStudMarriage() == 'S' ? "checked" : ""%> required>
                                    <label class="form-check-label" for="bujang">Bujang</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="stud_marriage" id="berkahwin" value="M" <%= st != null && st.getStudMarriage() == 'M' ? "checked" : ""%> required>
                                    <label class="form-check-label" for="berkahwin">Berkahwin</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="stud_marriage" id="bercerai" value="D" <%= st != null && st.getStudMarriage() == 'D' ? "checked" : ""%> required>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" class="form-control" id="stud_id" name="stud_id" value="<%= st != null ? st.getStudID() : ""%>" required>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="stud_course" class="form-label">Program</label>
                            <input type="text" class="form-control" id="stud_course" name="stud_course" value="<%= st != null ? st.getStudCourse() : ""%>" required>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="stud_faculty" class="form-label">Fakulti</label>
                            <input type="text" class="form-control" id="stud_faculty" name="stud_faculty" value="<%= st != null ? st.getStudFaculty() : ""%>" required>
                        </div>
                        <div class="col-md-3 mb-3">
                            <label for="stud_campus" class="form-label">Kampus</label>
                            <input type="text" class="form-control" id="stud_campus" name="stud_campus" value="<%= st != null ? st.getStudCampus() : ""%>" required>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="stud_bankNum" name="stud_bankNum" value="<%= st != null ? st.getStudBankNum() : ""%>" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="stud_bankName" class="form-label">Nama Bank</label>
                            <input type="text" class="form-control" id="stud_bankName" name="stud_bankName" value="<%= st != null ? st.getStudBankName() : ""%>" required>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="father_name" name="father_name" value="<%= gd1 != null ? gd1.getFather_name() : ""%>" required>
                    </div>
                    <div class="mb-3">
                        <label for="father_occupation" class="form-label">Pekerjaan</label>
                        <input type="text" class="form-control" id="father_occupation" name="father_occupation" value="<%= gd1 != null ? gd1.getFather_occupation() : ""%>" required>
                    </div>
                    <div class="mb-3">
                        <label for="father_income" class="form-label">Pendapatan</label>
                        <input type="text" class="form-control" id="father_income" name="father_income" value="<%= gd1 != null ? gd1.getFather_income() : ""%>" required>
                    </div>
                    <div class="mb-3">
                        <label for="father_address" class="form-label">Alamat</label>
                        <textarea class="form-control" id="father_address" name="father_address" rows="2" required><%= gd1 != null ? gd1.getFather_Address() : ""%></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="father_phoneNum" class="form-label">No. Telefon</label>
                        <input type="text" class="form-control" id="father_phoneNum" name="father_phoneNum" value="<%= gd1 != null ? gd1.getFather_phoneNum() : ""%>" required>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="mother_name" name="mother_name" value="<%= gd1 != null ? gd1.getMother_name() : ""%>" required>
                    </div>
                    <div class="mb-3">
                        <label for="mother_occupation" class="form-label">Pekerjaan</label>
                        <input type="text" class="form-control" id="mother_occupation" name="mother_occupation" value="<%= gd1 != null ? gd1.getMother_occupation() : ""%>" required>
                    </div>
                    <div class="mb-3">
                        <label for="mother_income" class="form-label">Pendapatan</label>
                        <input type="text" class="form-control" id="mother_income" name="mother_income" value="<%= gd1 != null ? gd1.getMother_income() : ""%>" required>
                    </div>
                    <div class="mb-3">
                        <label for="mother_address" class="form-label">Alamat</label>
                        <textarea class="form-control" id="mother_address" name="mother_address" rows="2" required><%= gd1 != null ? gd1.getMother_Address() : ""%></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="mother_phoneNum" class="form-label">No. Telefon</label>
                        <input type="text" class="form-control" id="mother_phoneNum" name="mother_phoneNum" value="<%= gd1 != null ? gd1.getMother_phoneNum() : ""%>" required>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="guard_name" name="guard_name" value="<%= gd1 != null ? gd1.getGuard_name() : ""%>" required>
                    </div>
                    <div class="mb-3">
                        <label for="guard_occupation" class="form-label">Pekerjaan</label>
                        <input type="text" class="form-control" id="guard_occupation" name="guard_occupation" value="<%= gd1 != null ? gd1.getGuard_occupation() : ""%>" required>
                    </div>
                    <div class="mb-3">
                        <label for="guard_income" class="form-label">Pendapatan</label>
                        <input type="text" class="form-control" id="guard_income" name="guard_income" value="<%= gd1 != null ? gd1.getGuard_income() : ""%>" required>
                    </div>
                    <div class="mb-3">
                        <label for="guard_address" class="form-label">Alamat</label>
                        <textarea class="form-control" id="guard_address" name="guard_address" rows="2" required><%= gd1 != null ? gd1.getGuard_address() : ""%></textarea>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" id="guard_postcode" name="guard_postcode" value="<%= gd1 != null ? gd1.getGuard_postcode() : ""%>" required>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="guard_phoneNum" class="form-label">No. Telefon</label>
                            <input type="text" class="form-control" id="guard_phoneNum" name="guard_phoneNum" value="<%= gd1 != null ? gd1.getGuard_phoneNum() : ""%>" required>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="guard_relation" class="form-label">Hubungan</label>
                            <input type="text" class="form-control" id="guard_relation" name="guard_relation" value="<%= gd1 != null ? gd1.getGuard_relation() : ""%>" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Kewarganegaraan</label>
                            <div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="guard_residence" id="warganegara" value="R" <%= gd1 != null && "R".equals(gd1.getGuard_residence()) ? "checked" : ""%> required>
                                    <label class="form-check-label" for="warganegara">Warganegara</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="guard_residence" id="bukan_warganegara" value="N" <%= gd1 != null && "N".equals(gd1.getGuard_residence()) ? "checked" : ""%> required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="other_income" name="other_income" value="<%= gd1 != null ? gd1.getOther_income() : ""%>" required>
                        </div>
                    </div>
                </div>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        nextBtn.addEventListener('click', () => {
            if (validateCurrentTab()) {
                ...
                if (nextTab) nextTab.click(); // Navigate to the next tab
            } else {
                alert('Sila isi semua maklumat yang diperlukan sebelum meneruskan.'); // Alert for missing fields
            }
        });
        ...
        prevBtn.addEventListener('click', () => {
            ...
            if (prevTab) prevTab.click(); // Navigate to the previous tab
        });
        ...
        submitBtn.addEventListener('click', () => {
            if (validateCurrentTab()) {
                document.getElementById('form-paginated').submit(); // Submit the form if valid
            } else {
                alert('Sila isi semua maklumat yang diperlukan sebelum menghantar.'); // Alert for missing fields
            }
        });
