...
<nav class="navbar text-light mb-3" style="background-color: #112C55">
    <div class="container-fluid d-flex align-items-center">
         <!-- Back Arrow -->
        <a href="UZSWdashboard.jsp" class="btn btn-outline-light me-3">
...
<div class="container">
    ...
    <ul class="nav nav-tabs mb-3" id="applicationTabs" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="total-tab" data-bs-toggle="tab" data-bs-target="#total" type="button" role="tab" aria-controls="total" aria-selected="false">Total</button>
        </li>
        <li class="nav-item" role="presentation">
   ...
   <!-- Tabs Content -->
        <div class="tab-content" id="applicationTabsContent">
            ...
            <tr>
                ...
                <td>
            <!-- Editable Interview Date Form -->
            <form action="updateInterviewDate.do" method="post" class="d-flex align-items-center">
                <!-- Hidden Input for ID -->
                <input type="hidden" name="studentId" value="2023******">
                <!-- Date Input -->
                <input 
                    type="date" 
